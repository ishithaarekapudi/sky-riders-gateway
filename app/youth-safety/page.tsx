...
export default function YouthSafetyPage() {
  return <PageShell active="get-involved">
    <main className="policy-page">
      ...
      <section><h2>Before a match</h2><ul><li>Mentor applicants must be at least 18 and are not publicly searchable.</li><li>Before matching launches, Gateway will review identity, experience, references, training, and appropriate screening requirements.</li><li>A parent or guardian must give verified consent before a minor can be matched.</li><li>Any future match will require approval by a Gateway coordinator.</li></ul></section>
