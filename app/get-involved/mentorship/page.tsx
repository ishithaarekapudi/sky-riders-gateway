...
export const metadata: Metadata = withPageSeo({ title: "Aviation and Aerospace Mentorship", description: "Apply to become a reviewed Sky Riders Gateway mentor or request aviation and aerospace guidance through a safeguarded matching process.", alternates: { canonical: "/get-involved/mentorship" } });
