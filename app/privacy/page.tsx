...
export const metadata: Metadata = withPageSeo({ title: "Privacy Policy", description: "Learn how Sky Riders Gateway collects, uses, safeguards, retains, and deletes personal information, including protections for young people.", alternates: { canonical: "/privacy" } });
...
export default function PrivacyPage() {
  return <PageShell active="resources">
    <main className="policy-page">
      ...
      <p className="policy-updated">Youth-focused privacy summary · Updated September 15, 2026</p>
      ...
      <section><h2>Cookies and similar technology</h2><p>Gateway and its service providers may use necessary cookies or similar technology to keep an account session working, prevent abuse, and process a request you make. Gateway does not use youth information for behavioral advertising. If optional analytics, advertising, or new providers are added, this policy will be updated before they are used.</p></section>
      <section><h2>Retention, access, and deletion</h2><p>We keep personal information only as long as needed for the purpose described, safety obligations, or applicable legal requirements. Rejected applications are scheduled for deletion after 90 days unless a safety or legal need requires longer retention. A user or guardian may <Link href="/privacy/delete">request access, correction, or deletion</Link>.</p></section>
