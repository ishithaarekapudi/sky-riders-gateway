...
export function ContentManager({ initial, submissions, setupError }: { initial: CatalogItem[]; submissions: Submission[]; setupError: boolean }) {
  ...
  return <section className="content-manager" aria-labelledby="content-manager-title">
    <div className="admin-section-intro"><div><span className="eyebrow">WEBSITE CONTENT</span><h2 id="content-manager-title">Find, edit, or add a listing</h2><p>Choose a directory below. Changes publish as soon as you save them.</p></div><p className="admin-helper">For organizations, use the partner button to show or remove a homepage partner.</p></div>
